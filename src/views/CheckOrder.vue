<template>
  ...
  <div class="auto-height">
    <div class="bg-dark auto-height-content">
      <div class="container">
        <div class="row">
          <div
      ...
      >
        <div class="row">
          <div class="col-10 col-md-6 mx-auto">
            ...
            <div class="row">
              <h3 class="tracking-widest font-bold text-3xl pb-3 mt-3 border-bottom-404040">
                商品資訊
              </h3>
  ...
  >
    ...
    <span
      class="position-absolute chat-span badge rounded-pill bg-light
      text-black animated pulse infinite delay-5s"
    >
      有問題能幫助您嗎？
    </span>
  </RouterLink>
        ...
        .then((response) => {
          ...
          if (response.data.order === null) {
            ...
            Swal.fire({
              ...
              footer:
                '辦公室地址:台北市信義區市府路101號<br>客服電話:(02)1010101<br>客服時間:週一至週五上午07:00~下午17:00<br>Email:DessertOfficer010@gmail.com',
            });
          } else {
            this.isLoading = false;
            this.getOrder = true;
