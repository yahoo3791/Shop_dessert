<template>
  ...
  <div class="bg-dark overflow-hidden">
      ...
      <div class="overflow-hidden homeContainer">
        <div class="homeBanner w-100 h-100 position-relative">
          ...
          <div class="position-absolute top-50 start-50 translate-middle">
            <span class="badge bg-warning text-dark fs-6"> 全站免運費中 </span>
            <h1 class="font-bold text-nowrap pt-2 banner-h1">專業、健康、新鮮現做的甜點店</h1>
            <h2 class="tracking-widest mb-5 banner-h2">軟在口中，甜在心上。</h2>
            <RouterLink to="/user/products" class="href-none d-block text-center">
              <button type="button" class="btn btn-light fw-bold">前往商店</button>
            </RouterLink>
          </div>
        </div>
      </div>
    ...
    <div class="container main" id="recommend">
      <div class="row">
        <div class="col-12 col-lg-6 my-2 position-relative" data-aos="fade-right">
          <img
          ...
          <div class="position-absolute top-50 translate-middle-y ps-5 tracking-widest">
            ...
            <RouterLink to="/user/products" class="href-none">
              <button type="button" class="btn btn-light fw-bold">前往商店</button>
            </RouterLink>
          </div>
        </div>
        <div class="col-12 col-lg-6 my-2 position-relative" data-aos="fade-left">
          <img
      ...
      <div class="row">
        ...
        <div class="col-6 col-md-6 col-lg-4 col-xl-3 mb-5" v-for="item in products" :key="item.id">
          <div
            class="text-white product-content-container mx-auto cursor-pointer position-relative"
            @click="more(item.id)"
            @keydown="more(item.id)"
          >
            <span class="badge bg-danger position-absolute badge-position"> HOT </span>
            <div class="product-item position-relative">
              ...
              <div
                ...
                @keydown="addFav(item)"
              >
                <i :class="favoriteData.includes(item.id) ? 'bi-heart-fill' : 'bi-heart'"
                class="bi mx-2 fs-1" />
              </div>
            </div>
        ...
        <div class="col-12 text-center my-5">
          <RouterLink to="/user/products" class="href-none">
            <button type="button" class="btn btn-light fw-bold">看更多</button>
          </RouterLink>
        </div>
      </div>
      <div class="line my-5" />
    ...
    <div class="container">
      <div class="row flex-column-reverse flex-lg-row-reverse align-items-lg-center">
        <div class="col-12 col-lg-6 text-center py-5 py-lg-0">
          ...
          <RouterLink to="/user/contact" class="href-none">
            <button type="button" class="btn btn-light fw-bold">聯絡我們</button>
          </RouterLink>
        </div>
    ...
    <div class="container">
      <div class="row py-5">
        ...
        <div
          ...
          data-aos="fade-left"
        >
          <img src="@/assets/pic/icon/CAS.png" class="markImg" alt="CAS優良食品標誌" />
          <div class="ps-2">
            <h5>CAS優良食品標誌</h5>
            <p>經學者、專家嚴格評核通過標準</p>
          </div>
        ...
        <div
          ...
          data-aos-delay="100"
        >
          <img src="@/assets/pic/icon/GMP.png" class="markImg" alt="GMP認證標章" />
          <div class="ps-2">
            <h5>GMP認證標章</h5>
        ...
        <div
          ...
          data-aos-delay="200"
        >
          <img src="@/assets/pic/icon/TAP.png" class="markImg" alt="TAP產銷履歷農產品" />
          <div class="ps-2">
            <h5>TAP產銷履歷農產品</h5>
        ...
        <div
          ...
          data-aos-delay="300"
        >
          <img src="@/assets/pic/icon/安全蔬果.png" class="markImg" alt="安全蔬果吉園圃標章" />
          <div class="ps-2">
            <h5>安全蔬果吉園圃標章</h5>
    ...
    <div class="container-fulid">
      <div class="subBg">
        <div class="mx-auto" style="max-width: 450px">
          <VForm @submit="submitEmail" class="position-relative form-outline form-white my-5">
            <h2 class="font-medium tracking-widest text-3xl d-block">訂閱甜點電子報</h2>
            <p>立馬獲得8折優惠卷</p>
            <div class="sub d-flex flex-wrap justify-content-center pt-3">
              <VField
                ...
                placeholder="EMAIL"
              />
              <button type="submitEmail" class="sub-btn d-inline-block text-black tracking-wide">
                <i class="bi bi-envelope footer-envelope" />
              </button>
              <ErrorMessage class="text-orange" :class="{ 'd-none': subMail == '' }" name="email" />
            </div>
          </VForm>
        </div>
      </div>
...
export default {
  setup() {
    ...
    const { scrollToTop, scrollIcon } = scrollMixins();
    ...
    const getData = () => {
      ...
      axios.get(api).then((response) => {
        ...
        products.value = response.data.products.filter((item) => {
    ...
    const productHistory = (id) => {
      ...
      history.value = localStorage.setItem('setHistory', JSON.stringify(history.value));
    };
    const more = (id) => {
