<template>
  <footer
    class="footer bg-dark text-center text-white position-relative bottom-0 w-100">
    <div class="container">
      <div class="row">
        <div class="col-12 col-md-6 mx-auto">
          <div class="follow my-2 my-md-4">
            <p
              class="footer-color font-medium tracking-wide pb-2
              text-base logo_font text-3xl">DESSERT
            </p>
            <a
              href="https://www.instagram.com/"
              target="_blank"
              rel="noreferrer noopenner"
              class="footer-active-hover ins me-lg-2">
